...
const masrgoURL = "http://localhost:8080/api";
...
function addCountry(event) {
  ...
  axios.post(`${masrgoURL}/countries/`, countryData)
  .then(response => {
...
function updateCountry(event) {
  ...
  axios.put(`${masrgoURL}/countries/${countryName}`, countryData)
  .then(response => {
      console.log(response.data);
  })
  .catch(error => {
...
function deleteCountry(event) {
  ...
  axios.delete(`${masrgoURL}/countries/${countryName}`)
  .then(response => {
      console.log(response.data);
  })
  .catch(error => {
